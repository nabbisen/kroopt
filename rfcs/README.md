...
| ID | Title | Shipped in |
|----|-------|------------|
| 046 | [Strict ClientHello and Extension Framing](done/046-strict-clienthello-and-extension-framing.md) | Implemented (AR1 B2; shipped `0.127.0`) — release commit `7fe6485`, tagged workflow `29920594779`, canonical 42/42 and immutable provenance assets published |
