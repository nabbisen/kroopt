...
| ID | Title | Shipped in |
|----|-------|------------|
| 046 | [Strict ClientHello and Extension Framing](done/046-strict-clienthello-and-extension-framing.md) | Implemented (AR1 B2; `0.127.0` candidate under review) — accepted at `ebae8f8`; clean closeout `797e2e1` passed 42/42 locally and in CI run `81034382238`; tagged-release evidence pending |
