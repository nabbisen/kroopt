...
- Expand the current GREASE evidence statement to the tested versions, suites, groups, signature schemes,
  ...
  including release-machinery controls and dedicated GCC 12.5/16.1 sanitizer lanes. Signed tag `0.127.0`
  identifies exact release commit `7fe6485`; tagged workflow run `29920594779` passed a fresh canonical
  42/42, release machinery, and strict real-release verification before publishing the three immutable
  assets recorded in `RELEASES.md`.
