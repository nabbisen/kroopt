...
[output actions](architecture/boundary.md); a thin interpreter executes those actions over
...
gates. See the [theorem inventory](verification/theorem-inventory.md).
